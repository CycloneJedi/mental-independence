...
const DAYS = [
  ...
  { day: 6, week: 1, prompt: "Where in your life are you most predictable — and is that chosen or installed?", depth: "Predictability isn't the enemy. Unconscious predictability is. The question isn't whether you're consistent, but whether you consciously chose the consistency or inherited it.", action: "Identify two areas of high predictability. Mark each: Chosen or Installed. What would it look like to consciously re-choose?" },
...
This isn't a conspiracy. There's no group deciding what you're allowed to think. It's more fundamental than that: it's a requirement of civilization. Large, complex societies cannot function if every individual interprets reality independently. So what societies do — elegantly, invisibly — is create predictability.`
    },
    {
...
WEEK 3 — EXPOSE: The nervous system updates on outcomes, not intentions. This week generates contact with the reality you've been avoiding — deliberately, incrementally. Small and real beats large and imagined.
